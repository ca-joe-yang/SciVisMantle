...
def print_light(light):
    print('Light setting:')
    print(f' * position:        {light.GetPosition()}')
    print(f' * focal point:     {light.GetFocalPoint()}')
    print(f' * cone angle:      {light.GetConeAngle()}')
    print(f' * ambient color:   {light.GetAmbientColor()}')
    print(f' * diffusion color: {light.GetDiffuseColor()}')
    print(f' * specular color:  {light.GetSpecularColor()}')
    print(f' * intensity:       {light.GetIntensity()}')
